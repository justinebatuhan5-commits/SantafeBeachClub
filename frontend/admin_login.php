            ...
            <div class="form-card">
                ...
                <form id="loginForm" method="POST" action="admin_login" autocomplete="on" novalidate>
                    ...
                    <div class="input-block">
                        ...
                        <div class="input-box">
                            <input type="email" id="username" name="username" autofocus autocomplete="username" value="<?php echo htmlspecialchars($_POST['username'] ?? ''); ?>" placeholder="admin@santabeachclub.com">
                    ...
                    <div class="input-block">
                        ...
                        <div class="input-box">
                            <input type="password" id="password" name="password" autocomplete="current-password" placeholder="Enter administrative password">
