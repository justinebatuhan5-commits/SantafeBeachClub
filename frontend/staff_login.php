            ...
            <div class="form-card">
                ...
                <form id="loginForm" method="POST" action="staff_login" autocomplete="on" novalidate>
                    ...
                    <div class="input-block">
                        ...
                        <div class="input-box">
                            <input type="email" id="username" name="username" autofocus autocomplete="username" value="<?php echo htmlspecialchars($_POST['username'] ?? ''); ?>" placeholder="reception@santabeachclub.com">
