            ...
            <div class="form-card">
                ...
                <form id="loginForm" method="POST" action="staff_login" autocomplete="on" novalidate>
                    ...
                    <div class="input-block">
                        ...
                        <div class="input-box">
                            <input type="email" id="username" name="username" required autofocus autocomplete="username" data-label="Email" value="<?php echo htmlspecialchars($_POST['username'] ?? ''); ?>" placeholder="reception@santabeachclub.com">
                    ...
                    <div class="input-block">
                        ...
                        <div class="input-box">
                            <input type="password" id="password" name="password" required autocomplete="current-password" data-label="Password" placeholder="Enter your password">
